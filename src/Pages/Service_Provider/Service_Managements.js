       ...
       <Header Header={<div className="header_color_grey header_height">
        ...
        <div className='center margin_top'>
          <div className=''>
            ...
            <h4 className="heading_4"> Integrating with the Verified Network gives you access to a network of merchant businesses and individuals with a global userbase. </h4>
        ...
        <div className='section_1 padding-top'>
          ...
          <div className='margin_right margin_left margin_top_100'>
            <h2 className='heading font-weight font-size-40'> Digital Asset Custody</h2>
            <p className="pragraph_1">Exercise control on assets by providing regulated custody for fiat currencies paid by investors on the Verified Network.</p>
            <p className="pragraph_1">Settle funds for issuance of tokenized securities by businesses. </p>
        ...
        <div className='section_1 padding-top'>
          ...
          <div className='margin_right margin_left margin_top_100'>
            <h2 className='heading font-weight font-size-40'> Transfer Agency</h2>
            <p className="pragraph_1">Function as a regulated custodian and provide custody for underlying assets of tokenized securities.</p>
            <p className="pragraph_1">Transfer assets from sellers to buyers to fulfill transactions of tokenized securities.</p>
            <h4 className='Learn-More_1 color-parpule margin_left NavLink'>Try it out <span><img src="images/Group (3).png" /></span></h4>
          </div>
        ...
        <div className='section_1 padding-top'>
          ...
          <div className='margin_right margin_left margin_top_100'>
            <h2 className='heading font-weight font-size-40'>Register Tokenized Securities</h2>
            <p className="pragraph_1">Partner with businesses on the Verified Network and register shares and bonds issued by them  with national depositories  and on the blockchain ledger, subject to country regulations.</p>
            <p className="pragraph_1">Offer registered tokenized securities for subscription to investors on the Verified Network.</p>
            <h4 className='Learn-More_1 color-parpule margin_left NavLink'>Try it out <span><img src="images/Group (3).png" /></span></h4>
          </div>
        </div>
