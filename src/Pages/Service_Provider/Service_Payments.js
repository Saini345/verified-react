      ...
      <Header Header={<div className="header_color_grey header_height">
        ...
        <div className='center margin_top'>
          <div className=''>
            ...
            <h4 className="heading_4"> </h4>
            <h4 className="heading_4 margin_top">Integrating with the Verified Network gives you access to a network of merchant businesses and individuals with a global userbase. <h4 className="heading_4 margin_top"> Create your Verified account today</h4></h4>
...
you can Trust." />
        ...
        <div className='section_1 padding-top'>
          <div className='margin_left'>
            <img className='Group_17519_service_img' src="images/Group 17519_service.png" />
          </div>

          <div className='margin_right margin_left margin_top_100'>
            <h2 className='heading font-weight font-size-40'> Digital Payments</h2>
            <p className="pragraph_1">Be immune to economic instability by accepting local fiat currency paid by account holders as regulated payment institution.</p>
            <p className="pragraph_1">Be immune to economic instability by accepting local fiat currency paid by account holders as regulated payment institution.</p>
        ...
        <div className='section_1 padding-top'>
          ...
          <div className='margin_right margin_left margin_top_100'>
            <h2 className='heading font-weight font-size-40'> Payment Acceptance</h2>
            <p className="pragraph_1">Accept digital cash tokens transfers from account holders in multiple foreign currencies.</p>
            <p className="pragraph_1">Pay out local fiat currency to beneficiaries in exchange for regulated payment institution.</p>
            <h4 className='Learn-More_1 color-parpule margin_left NavLink'>Try it out <span><img src="images/Group (3).png" /></span></h4>
          </div>
...
export default Service_Payments
