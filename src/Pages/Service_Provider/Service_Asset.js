    ...
    <div>
      <Header Header={<div className="header_color_grey header_height">
        ...
        <div className='center margin_top'>
          <div className=''>
            <h2 className='heading_2 '>Service the Verified Network</h2>
        ...
        <div className='section_1 padding-top'>
          ...
          <div className='margin_right margin_left margin_top_100'>
            <h2 className='heading font-weight font-size-40'> Create Assets that are Credit Worthy.</h2>
            <p className="pragraph_1">Originate digital assets and issue securities that are secure and credit worthy for clients on the Verified Network.</p>
            <p className="pragraph_1">Take advantage of liquidity and capital on any exchange connected to the Verified Network.</p>
        ...
        <Box Box={<div className='box box-height-330 margin_right margin_left Invest margin_top_100'>
          ...
          <h4 className='font-size-18 font-weight-400 heading padding_top_60'>Host a Verified Network node</h4>
          <Heading className='padding_t font-size-40' heading="Host a Verified Network node" />
