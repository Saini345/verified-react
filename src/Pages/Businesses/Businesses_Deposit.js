    ...
    <div>
      ...
      <div className='section_1 padding-top'>
        <div className='margin_left'>
          <img className='bussiness_deposits_img' src="images/bussiness_deposits.png" />
        </div>

        <div className='margin_right margin_left margin_top_100'>
          <h2 className='heading font-weight font-size-40'> Deposit in Stable Currencies</h2>
          <p className="pragraph">Keep your money safe from economic fluctuations through fiat currencies in your Verified Network account – that lets you convert local currencies into stable global currencies at competitive rates.</p>
...
export default Businesses_Deposit
