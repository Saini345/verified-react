    ...
    <div>
      ...
      <Individual_Pages individual_Pages={
        <div className='Accounts-assets margin_left margin_right section_2'>
          <div className='icon-images-flex pt'>
            <Link to="/Businesses"><img className='icon-images-hw margin_left_50' src="images/Account-icon.png" /></Link>
      ...
      <div className='section_1 padding-top'>
        ...
        <div className='margin_right margin_left margin_top_100'>
          ...
          <p className="pragraph">Stop paying high fees to banks for custody of your assets. Keep your assets secure with Verified self-custody and make their value go the extra mile.</p>
...
export default Businesses_Asset
