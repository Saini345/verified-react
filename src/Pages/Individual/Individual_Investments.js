     ...
     <div>
      ...
      <div className='section_1 padding-top '>
        ...
        <div className='margin_right margin_left margin_top_100'>
          <h2 className='heading font-weight font-size-40'>Higher Return Investments</h2>
          <p className="pragraph_1">Earn interest on your assets by purchasing investment products on the Verified Network. </p>
          <p className="pragraph_1">Benefit from higher interest rates outside your local currency on investments into financial products across the globe.</p>
      ...
      <div className='section_1 padding-top '>
        ...
        <div className='margin_right margin_left margin_top_100'>
          <h2 className='heading font-weight font-size-40'>Private Investment Opportunities</h2>
          <p className="pragraph_1">Explore private investment opportunities from the best asset managers.</p>
          <p className="pragraph_1">Access to the best investment deals without opening an expensive wealth account.</p>
          <h4 className='Learn-More_1 color-parpule margin_left NavLink'>Try it out <span><img src="images/Group (3).png" /></span></h4>
        </div>
      ...
      <div className='section_1 padding-top '>
        ...
        <div className='margin_right margin_left margin_top_100'>
          <h2 className='heading font-weight font-size-40'>Liquidity For Private Investments</h2>
          <p className="pragraph_">Sell your private investments directly and get access to liquidity when you need it – without having to pay expensive brokerage for trading investments. </p>
          <h4 className='Learn-More_1 color-parpule margin_left NavLink'>Try it out <span><img src="images/Group (3).png" /></span></h4>
        </div>
      </div>
